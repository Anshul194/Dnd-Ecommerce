    ...
    <div className="flex items-center gap-2">
      <div className="flex">
        {[...Array(5)].map((_, i) => (
          <Star
            key={i}
            className={`w-3 h-3 ${i < filled ? 'fill-green-500 text-green-500' : 'text-gray-300'}`}
          />
        ))}
      </div>
      ...
      {/* <div className="grid grid-cols-1 lg:grid-cols-2 gap-12"> */}
        ...
        <div className="max-w-2xl">
          ...
          <p className="text-black relative max-w-sm poppins-medium leading-tight text-lg mb-8">
            Lorem ipsum dolor <span className="text font-semibold">consectetur</span> eiusmod 
              ...
              <div key={index} className="flex items-center gap-3">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`w-3 h-3 ${i < item.stars ? 'fill-green-500 text-green-500' : 'text-gray-300'}`}
                    />
                  ))}
                </div>
        ...
        {reviews.map((review, index) => (
          <div key={index} className="bg-white relative">
            ...
            <div className="flex items-center justify-between gap-3 mb-3">
              ...
              <div>
                <div className="font-medium text-sm text-black">{review.name}</div>
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
              ...
              <Image src="/images/verified.png" alt="Verified" width={18} height={18} className="rounded-full opacity-90" />
            </div>
            ...
            <div className='flex gap-2 justify-between'>
                {/* Review Image */}
                <d
                iv className="bg-gray-400 rounded h-24 w-full mb-4"></d>

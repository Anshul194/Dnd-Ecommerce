import { Star, ThumbsUp, ThumbsDown, MessageCircle, Quote, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  const [data, setData] = useState({
    ...
    Reviews: [
      ...
      },
      {
        ...
        rating: 5,
        comment: "The laptop package has arrived complete with charger, 2 mics, 1 headset. The laptop is really cool, good performance and sturdy, hope it lasts long. Thank you. Good luck with the sale",
        likes: 8,
        dislikes: 12,
        comments: 0,
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[60vh] mb-16">
          <div className="flex flex-col justify-center pr-0 lg:pr-12 mb-8 lg:mb-0">
            <div className="relative">
              <h1 className="text-7xl md:text-9xl lg:text-[120px] leading-none font-bold mb-6" 
            ...
            <p className="text-gray-600 text-lg max-w-md leading-relaxed" 
              ...
              Real experiences from real customers. Every review tells a story of 
        ...
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-12 text-center" style={{ fontFamily: 'Bebas Neue, cursive' }}>
            CUSTOMER REVIEWS
          </h2>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                      ...
                      <div className="flex items-center gap-2 text-gray-600 hover:text-blue-600 cursor-pointer">
                        ...
                        <span className="text-sm font-medium">{review.comments} replies</span>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <div className="text-center bg-gray-100 rounded-3xl p-12 mt-16">
          <h3 className="text-4xl font-bold mb-4 text-green-600" style={{ fontFamily: 'Bebas Neue, cursive' }}>

...
class InfluencerVideoController {
  async createInfluencerVideo(req, _res, conn) {
    try {
      ...
      console.log('[InfluencerVideoController.createInfluencerVideo] Creating influencer video for user:', userId, 'Body:', JSON.stringify(body, null, 2));
      ...
      console.error('[InfluencerVideoController.createInfluencerVideo] Error:', err.message, err.stack);
  ...
  async getInfluencerVideoById(req, _res, id, conn) {
    try {
      console.log('[InfluencerVideoController.getInfluencerVideoById] Fetching influencer video:', id, 'Connection:', conn.name || 'global mongoose');
      ...
      console.error('[InfluencerVideoController.getInfluencerVideoById] Error:', err.message, err.stack);
      return NextResponse.json({ error: err.message }, { status: 400 });
    }
  }
  ...
  async getAllInfluencerVideos(req, _res, conn) {
    try {
      console.log('[InfluencerVideoController.getAllInfluencerVideos] Fetching all influencer videos', 'Connection:', conn.name || 'global mongoose');
      ...
      console.error('[InfluencerVideoController.getAllInfluencerVideos] Error:', err.message, err.stack);
      return NextResponse.json({ error: err.message }, { status: 400 });
    }
  }
  ...
  async updateInfluencerVideo(req, _res, id, conn) {
    try {
      ...
      console.log('[InfluencerVideoController.updateInfluencerVideo] Updating influencer video:', id, 'for user:', userId, 'Body:', JSON.stringify(body, null, 2));
      ...
      console.error('[InfluencerVideoController.updateInfluencerVideo] Error:', err.message, err.stack);
      return NextResponse.json({ error: err.message }, { status: 400 });
    }
  }
  ...
  async deleteInfluencerVideo(req, _res, id, conn) {
    try {
      const userId = req.user._id;
      console.log('[InfluencerVideoController.deleteInfluencerVideo] Deleting influencer video:', id, 'for user:', userId, 'Connection:', conn.name || 'global mongoose');
      ...
      console.error('[InfluencerVideoController.deleteInfluencerVideo] Error:', err.message, err.stack);
      return NextResponse.json({ error: err.message }, { status: 400 });
    }
  }
}

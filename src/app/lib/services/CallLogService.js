...
class CallLogService {
  ...
  async getCallLogsByLeadId(conn, { leadId, page = 1, limit = 10, search = '' }) {
    console.log('[CallLogService.getCallLogsByLeadId] Fetching call logs for leadId:', leadId, 'Connection:', conn.name || 'global mongoose', 'Page:', page, 'Limit:', limit, 'Search:', search);
    return await callLogRepository.getCallLogsByLeadId(conn, { leadId, page, limit, search });
  }
}
